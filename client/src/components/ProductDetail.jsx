      ...
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
              ...
              <div>
                ...
                <RadioGroup value={selectedColor} onChange={setSelectedColor} className="mt-4">
                  ...
                  <div className="flex items-center space-x-3">
                    {/* Add colors from product.colors */}
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                ...
                <div className="mt-10">
                  <h3 className="text-sm font-medium text-gray-900">Related Products</h3>
                  <div className="mt-4 grid grid-cols-2 gap-4">
                    {product.relatedProducts.map((related) => (
                      <div key={related.id} className="flex flex-col items-center">
                        <img src={related.image} alt={related.name} className="h-32 w-32 object-cover" />
                        <h4 className="mt-2 text-sm font-medium text-gray-900">{related.name}</h4>
